...
<%
    try {
        ...
        pi.getFormufle().getChamp("idProduit_0").setLibelle("Prix Unitaire");
        ...
        String[] ordre = {"idProduit", "prixUnitaire","designation", "quantites","remarque"};
        // pi.getFormufle().setOrdre(ordre);
