...
<%
          InformationAnnexeLib info = new InformationAnnexeLib();
//          info.setNomTable(table);
          PageConsulte pc = new PageConsulte( info, request, (user.UserEJB) session.getValue("u") );
          info = (InformationAnnexeLib) pc.getBase();
          ...
          pc.getChampByName("valeurPossible").setLibelle("Les valeurs Possibles");
          pc.getChampByName("idTypeChamp").setVisible(false);
          pc.getChampByName("typeChamp").setLibelle("Type de champ");
