...
try {
    ...
    String idstock = facture.stocker(""+u.getUser().getRefuser(), null);
    %>
    <script language="JavaScript"> document.location.replace("<%=lien%>?but=stock/mvtstock-fiche.jsp&id=<%=idstock%>");</script>
    <%
    }catch (Exception e) {
        e.printStackTrace();
    %>
