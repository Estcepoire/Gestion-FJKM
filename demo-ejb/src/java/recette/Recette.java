...
public class Recette extends ClassEtat {
    String id;
    String designation;
    Date daty;
    String idtyperecette;
    double montant;
    ...
    public String getIdtyperecette() {
        return idtyperecette;
    }

    public void setIdtyperecette(String idtyperecette) {
    ...
    public void construirePK(Connection c) throws Exception {
        this.preparePk("DEP", "GET_SEQrecette");
        this.setId(makePK(c));
    }

    public Recette() {
        this.setNomTable("recette");
    }
    ...
    public String getIdtyperecettelib() {
        return idtyperecettelib;
    }

    public void setIdtyperecettelib(String idtyperecettelib) {
        this.idtyperecettelib = idtyperecettelib;
    }
    ...
    public String genererCaisse(String u, Connection c, String idCaisse) throws Exception {
        ...
        try {
            ...
            if (this.getEtat() == 11) {
                ...
                throw new Exception("La recette doit &ecirc;tre valid&eacute;e");
            }
        } catch (Exception e) {
            throw e;
        } finally {
